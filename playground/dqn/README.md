Deep Q-Learning (Q-Network) Approach to the trading problem
...
- Try to use a recurrent neural network for approximating the q-values because the price data are inherently sequential